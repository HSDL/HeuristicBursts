...
def test_simulation_of_wec():
    ...
    device.add_rotational_body('sphere', 650.0, (430, 0), 0, 1, 0, 1000, 10000000, radius=10)
    device.add_rotational_body('sphere', 800.0, (430, -30), 1, 2, 0, 1000, 10000000, radius=10)
    device.change_joint_type(1, 'rotational')
    device.add_linear_body('sphere', 650.0, (460, 0), 1, 3, 30, 1000, 10000000, radius=10)
    device.relocate_body_with_joint(3, 1, 'linear', (370, 0), 0)
    device.change_body_density(2, 850.0)
    device.add_mooring_system((400, -150), 0, 150, 1000, 10000000)
