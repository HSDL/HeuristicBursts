...
def test_simulation_of_wec():
    ...
    device.add_rotational_body('sphere', 650.0, (430, 0), 0, 0, 1000, 10000000, radius=5)
    device.add_rotational_body('sphere', 800.0, (430, -30), 1, 0, 1000, 10000000, radius=5)
    device.change_joint_type(1, 'rotational')
    device.add_linear_body('sphere', 650.0, (460, 0), 1, 1000, 10000000, radius=5)
