...
# with open('higher_tier_only_500_iterations.csv', 'w') as sim_data_file:
...
for sim_num in range(0, 25):
    ...
    with open('higher_tier_only_500_iterations.csv', 'r') as sim_data_file:
    ...
    with open('higher_tier_only_500_iterations.csv', 'a') as sim_data_file:
