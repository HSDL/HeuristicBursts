...
def test_simulation_of_wec():
    ...
    device.add_rotational_body('cylinder', 650.0, (420, 0), 0, 1, 0, 1000, 10000000, radius=5, length=10, angle_offset=0)
    device.add_rotational_body('cylinder', 650.0, (440, 0), 1, 2, 0, 1000, 10000000, radius=5, length=10, angle_offset=0)
