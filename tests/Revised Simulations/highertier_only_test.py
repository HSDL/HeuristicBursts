...
with open('random_walk_higher_tier_50_iterations.csv', 'w') as sim_data_file:
...
for sim_num in range(0, 50):
    ...
    with open('random_walk_higher_tier_50_iterations.csv', 'r') as sim_data_file:
    ...
    with open('random_walk_higher_tier_50_iterations.csv', 'a') as sim_data_file:
