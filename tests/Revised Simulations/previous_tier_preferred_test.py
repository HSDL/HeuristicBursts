...
# with open('previous_tier_preferred_test_500_iterations.csv', 'w') as sim_data_file:
...
for sim_num in range(0, 50):
    ...
    with open('previous_tier_preferred_test_500_iterations.csv', 'r') as sim_data_file:
    ...
    with open('previous_tier_preferred_test_500_iterations.csv', 'a') as sim_data_file:
