...
with open('lower_tier_only_500_iterations.csv', 'r') as sim_data_file:
...
plt.errorbar(numpy.arange(500), avg_iter_qual_a, yerr=iter_err_a, color='b', ecolor='b', elinewidth=0.25, label="Lower-Tier Only")
plt.errorbar(numpy.arange(500), avg_iter_qual_b, yerr=iter_err_b, color='g', ecolor='g', elinewidth=0.25, label="Markov w/ Both Tiers")
plt.errorbar(numpy.arange(500), avg_iter_qual_c, yerr=iter_err_c, color='m', ecolor='m', elinewidth=0.25, label="Probabilistic Method w/ Both Tiers")
plt.legend(loc=4)
