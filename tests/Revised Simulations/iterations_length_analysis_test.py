...
file_a = 'both_tiers_500_iterations.csv'
file_b = 'probabilistic_selection_test_500_iterations.csv'
file_c = 'markov_test_500_iterations.csv'
file_d = 'previous_tier_preferred_test_500_iterations.csv'

label_a = "Random Selection w/ Both Tiers"
label_b = "Probabilistic Selection w/ Both Tiers"
label_c = "Markov Selection w/ Both Tiers"
label_d = "Previous Tier Preferred"
